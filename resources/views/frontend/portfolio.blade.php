...
<head>
    ...
    <title>Natia - Personal Portfolio Template</title>
...
<body>
                    ...
                    <div class="page-next">
                        <nav aria-label="breadcrumb" class="d-inline-block">
                            <ul class="breadcrumb rounded mb-0 mt-3">
                                <li class="breadcrumb-item text-white"><a class='text-white' href='index.html'>Home</a></li>
          ...
          <div class="row align-items-center">
            ...
            <div id="gallery-wrapper" class="row projects-wrapper gy-4">
                <div class="col-lg-4 col-md-6 col-12 picture-item" data-groups='["branding"]'>
                    <div class="work-container position-relative d-block overflow-hidden rounded">
                        <div class="card-body p-0">
                            <img src="asset/images/portfolio/01.jpg" class="img-fluid" alt="work-image">
                ...
                <div class="col-lg-4 col-md-6 col-12 picture-item" data-groups='["designing"]'>
                    <div class="work-container position-relative d-block overflow-hidden rounded">
                        <div class="card-body p-0">
                            <img src="asset/images/portfolio/02.jpg" class="img-fluid" alt="work-image">
                            <div class="overlay-work bg-dark"></div>
                            <div class="content">
                                <h5 class="mb-3"><a class='content-title' href='javascript:void(0)'>Mockup Collection</a></h5>
                                <h6 class="text-light tag mb-0">Mockup</h6>
                ...
                <div class="col-lg-4 col-md-6 col-12 picture-item" data-groups='["photography"]'>
                    <div class="work-container position-relative d-block overflow-hidden rounded">
                        <div class="card-body p-0">
                            <img src="asset/images/portfolio/03.jpg" class="img-fluid" alt="work-image">
                            <div class="overlay-work bg-dark"></div>
                            <div class="content">
                                <h5 class="mb-3"><a class='content-title' href='javascript:void(0)'>Mockup Collection</a></h5>
                                <h6 class="text-light tag mb-0">Mockup</h6>
                ...
                <div class="col-lg-4 col-md-6 col-12 picture-item" data-groups='["development"]'>
                    <div class="work-container position-relative d-block overflow-hidden rounded">
                        <div class="card-body p-0">
                            <img src="asset/images/portfolio/04.jpg" class="img-fluid" alt="work-image">
                            <div class="overlay-work bg-dark"></div>
                            <div class="content">
                                <h5 class="mb-3"><a class='content-title' href='javascript:void(0)'>Mockup Collection</a></h5>
                                <h6 class="text-light tag mb-0">Mockup</h6>
                ...
                <div class="col-lg-4 col-md-6 col-12 picture-item" data-groups='["branding"]'>
                    <div class="work-container position-relative d-block overflow-hidden rounded">
                        <div class="card-body p-0">
                            <img src="asset/images/portfolio/05.jpg" class="img-fluid" alt="work-image">
                            <div class="overlay-work bg-dark"></div>
                            <div class="content">
                                <h5 class="mb-3"><a class='content-title' href='javascript:void(0)'>Mockup Collection</a></h5>
                                <h6 class="text-light tag mb-0">Mockup</h6>
                ...
                <div class="col-lg-4 col-md-6 col-12 picture-item" data-groups='["designing"]'>
                    <div class="work-container position-relative d-block overflow-hidden rounded">
                        <div class="card-body p-0">
                            <img src="asset/images/portfolio/06.jpg" class="img-fluid" alt="work-image">
                            <div class="overlay-work bg-dark"></div>
                            <div class="content">
                                <h5 class="mb-3"><a class='content-title' href='javascript:void(0)'>Mockup Collection</a></h5>
                                <h6 class="text-light tag mb-0">Mockup</h6>
                ...
                <div class="col-lg-4 col-md-6 col-12 picture-item" data-groups='["photography"]'>
                    <div class="work-container position-relative d-block overflow-hidden rounded">
                        <div class="card-body p-0">
                            <img src="asset/images/portfolio/14.jpg" class="img-fluid" alt="work-image">
                            <div class="overlay-work bg-dark"></div>
                            <div class="content">
                                <h5 class="mb-3"><a class='content-title' href='javascript:void(0)'>Mockup Collection</a></h5>
                                <h6 class="text-light tag mb-0">Mockup</h6>
                ...
                <div class="col-lg-4 col-md-6 col-12 picture-item" data-groups='["development"]'>
                    <div class="work-container position-relative d-block overflow-hidden rounded">
                        <div class="card-body p-0">
                            <img src="asset/images/portfolio/17.jpg" class="img-fluid" alt="work-image">
                            <div class="overlay-work bg-dark"></div>
                            <div class="content">
                                <h5 class="mb-3"><a class='content-title' href='javascript:void(0)'>Mockup Collection</a></h5>
                                <h6 class="text-light tag mb-0">Mockup</h6>
                ...
                <div class="col-lg-4 col-md-6 col-12 picture-item" data-groups='["branding"]'>
                    <div class="work-container position-relative d-block overflow-hidden rounded">
                        <div class="card-body p-0">
                            <img src="asset/images/portfolio/18.jpg" class="img-fluid" alt="work-image">
                            <div class="overlay-work bg-dark"></div>
                            <div class="content">
                                <h5 class="mb-3"><a class='content-title' href='javascript:void(0)'>Mockup Collection</a></h5>
                                <h6 class="text-light tag mb-0">Mockup</h6>
                            ...
                            <div class="row">
                                    ...
                                    <div class="colum md-mb50">
                                        ...
                                        <div class="footer-subtitle footer-text-style">
                                            <p class="mb-10 footer-text-style">
                                                <a href="javascript:void(0)" class="footer-text-style">hello@design.com</a>
                                            </p>
                                            <h5>
                                ...
                                <div class="col-lg-2 col-md-2 md-mb50">
                                    ...
                                    <ul class="social-text">
                                        <li class="mb-2"><a href="javascript:void(0)">Facebook</a></li>
                                        <li class="mb-2"><a href="javascript:void(0)">Twitter</a></li>
                                        <li class="mb-2"><a href="javascript:void(0)">LinkedIn</a></li>
                                        <li class="mb-2"><a href="javascript:void(0)">Instagram</a></li>
                                    </ul>
                                </div>
                                                ...
                                                <div class="position-relative">
                                                    ...
                                                    <button type="submit" class="d-inline-flex align-items-center justify-content-center">
                                                        <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"
                                                            class="lucide lucide-arrow-right"><path d="M5 12h14" /><path d="m12 5 7 7-7 7" />
                                                        </svg>
                                                    </button>
                                                </div>
                                            </div>
            ...
            <div class="footer-bar pt-30 pb-30">
                <div class="container">
                    <div class="row">
                        <div class="col-lg-6">
                            <div class="logo">
                                <a href="javascript:void(0)"><img src="images/logo-light.png" class="img-fluid"></a>
                            </div>
                        </div><!--end col-->
                        ...
                        <div class="col-lg-6">
                            <div class="copyright d-flex">
                                <div class="ms-auto">
                                    <p class="mb-0">© <script>document.write(new Date().getFullYear())</script> Natia. Design with <i class="mdi mdi-heart text-danger"></i> by <a href="https://zoyothemes.com/" target="_blank" class="text-reset">Zoyothemes</a>.</p>
                                </div>
                            </div>
                        </div><!--end col-->
                    </div><!--end row-->
    ...
    <!-- Back to top -->
    <a href="#" onclick="topFunction()" id="back-to-top" class="back-to-top rounded text-center align-items-center justify-content-center fs-5">
